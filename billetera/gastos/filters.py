...
class GastoFilter(django_filters.FilterSet):
    ...
    categoria = django_filters.CharFilter(field_name='categoria__nombre', lookup_expr='icontains', label='Categoría', widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Categoría'}))
